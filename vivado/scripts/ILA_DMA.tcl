...
################################################################
# This is a generated script based on design: ILA_DMA
#
...
proc create_root_design { parentCell } {
  ...
  set m01_axi_init_axi_txn_0 [ create_bd_port -dir I m01_axi_init_axi_txn_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Top_DMA_0_M00_AXI [get_bd_intf_pins Top_DMA_0/M00_AXI] [get_bd_intf_pins microblaze_riscv_0_axi_periph/S01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets Top_DMA_0_M00_AXI] [get_bd_intf_pins Top_DMA_0/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  connect_bd_intf_net -intf_net Top_DMA_0_M01_AXI [get_bd_intf_pins Top_DMA_0/M01_AXI] [get_bd_intf_pins microblaze_riscv_0_axi_periph/S02_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets Top_DMA_0_M01_AXI] [get_bd_intf_pins Top_DMA_0/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M02_AXI] [get_bd_intf_pins Top_DMA_0/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets microblaze_riscv_0_axi_periph_M02_AXI] [get_bd_intf_pins microblaze_riscv_0_axi_periph/M02_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  # Create port connections
  connect_bd_net -net Top_DMA_0_m00_axi_error [get_bd_pins Top_DMA_0/m00_axi_error] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net Top_DMA_0_m00_axi_txn_done [get_bd_pins Top_DMA_0/m00_axi_txn_done] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net Top_DMA_0_m01_axi_error [get_bd_pins Top_DMA_0/m01_axi_error] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net Top_DMA_0_m01_axi_txn_done [get_bd_pins Top_DMA_0/m01_axi_txn_done] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_100M/dcm_locked]
  connect_bd_net -net m00_axi_init_axi_txn_0_1 [get_bd_ports m00_axi_init_axi_txn_0] [get_bd_pins Top_DMA_0/m00_axi_init_axi_txn] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net m01_axi_init_axi_txn_0_1 [get_bd_ports m01_axi_init_axi_txn_0] [get_bd_pins Top_DMA_0/m01_axi_init_axi_txn] [get_bd_pins system_ila_0/probe5]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets m01_axi_init_axi_txn_0_1]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_riscv_0_Clk [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_riscv_0/Clk] [get_bd_pins microblaze_riscv_0_axi_periph/ACLK] [get_bd_pins microblaze_riscv_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_riscv_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_riscv_0_axi_intc/processor_clk] [get_bd_pins microblaze_riscv_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_riscv_0_axi_periph/M01_ACLK] [get_bd_pins Top_DMA_0/m00_axi_aclk] [get_bd_pins microblaze_riscv_0_axi_periph/S01_ACLK] [get_bd_pins Top_DMA_0/m01_axi_aclk] [get_bd_pins microblaze_riscv_0_axi_periph/S02_ACLK] [get_bd_pins Top_DMA_0/s00_axi_aclk] [get_bd_pins microblaze_riscv_0_axi_periph/M02_ACLK] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_mb_reset [get_bd_pins rst_clk_wiz_0_100M/mb_reset] [get_bd_pins microblaze_riscv_0/Reset] [get_bd_pins microblaze_riscv_0_axi_intc/processor_rst]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/ARESETN] [get_bd_pins microblaze_riscv_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_riscv_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/M01_ARESETN] [get_bd_pins Top_DMA_0/m00_axi_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/S01_ARESETN] [get_bd_pins Top_DMA_0/m01_axi_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/S02_ARESETN] [get_bd_pins Top_DMA_0/s00_axi_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/M02_ARESETN] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs Top_DMA_0/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M00_AXI] [get_bd_addr_segs Top_DMA_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M00_AXI] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M00_AXI] [get_bd_addr_segs microblaze_riscv_0_axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M01_AXI] [get_bd_addr_segs Top_DMA_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M01_AXI] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M01_AXI] [get_bd_addr_segs microblaze_riscv_0_axi_intc/S_AXI/Reg] -force
