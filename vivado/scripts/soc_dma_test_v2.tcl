...
################################################################
# This is a generated script based on design: soc_dma_test_v2
#
...
# source soc_dma_test_v2_script.tcl
...
set design_name soc_dma_test_v2
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Top_DMA_2D_0, and set properties
  set Top_DMA_2D_0 [ create_bd_cell -type ip -vlnv user.org:user:Top_DMA_2D:1.0 Top_DMA_2D_0 ]
  set_property -dict [list \
    CONFIG.C_M00_AXI_BURST_LEN {64} \
    CONFIG.C_M01_AXI_BURST_LEN {64} \
  ] $Top_DMA_2D_0


  # Create interface connections
  connect_bd_intf_net -intf_net Top_DMA_2D_0_M00_AXI [get_bd_intf_pins Top_DMA_2D_0/M00_AXI] [get_bd_intf_pins microblaze_riscv_0_axi_periph/S01_AXI]
  connect_bd_intf_net -intf_net Top_DMA_2D_0_M01_AXI [get_bd_intf_pins Top_DMA_2D_0/M01_AXI] [get_bd_intf_pins microblaze_riscv_0_axi_periph/S02_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M01_AXI] [get_bd_intf_pins Top_DMA_2D_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M03_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_bram_ctrl_1/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net Top_DMA_2D_0_m00_axi_error  [get_bd_pins Top_DMA_2D_0/m00_axi_error] \
  [get_bd_pins microblaze_riscv_0_xlconcat/In2]
  connect_bd_net -net Top_DMA_2D_0_m00_axi_txn_done  [get_bd_pins Top_DMA_2D_0/m00_axi_txn_done] \
  [get_bd_pins microblaze_riscv_0_xlconcat/In1]
  connect_bd_net -net Top_DMA_2D_0_m01_axi_error  [get_bd_pins Top_DMA_2D_0/m01_axi_error] \
  [get_bd_pins microblaze_riscv_0_xlconcat/In4]
  connect_bd_net -net Top_DMA_2D_0_m01_axi_txn_done  [get_bd_pins Top_DMA_2D_0/m01_axi_txn_done] \
  ...
  [get_bd_pins Top_DMA_2D_0/s00_axi_aclk] \
  [get_bd_pins Top_DMA_2D_0/m00_axi_aclk] \
  [get_bd_pins Top_DMA_2D_0/m01_axi_aclk]
  ...
  [get_bd_pins Top_DMA_2D_0/s00_axi_aresetn] \
  [get_bd_pins Top_DMA_2D_0/m00_axi_aresetn] \
  [get_bd_pins Top_DMA_2D_0/m01_axi_aresetn]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs Top_DMA_2D_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xC0000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC2000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M00_AXI] [get_bd_addr_segs Top_DMA_2D_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xC0000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC2000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  assign_bd_address -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M00_AXI] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M00_AXI] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M00_AXI] [get_bd_addr_segs microblaze_riscv_0_axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M01_AXI] [get_bd_addr_segs Top_DMA_2D_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xC0000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M01_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC2000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M01_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  assign_bd_address -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M01_AXI] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M01_AXI] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_2D_0/M01_AXI] [get_bd_addr_segs microblaze_riscv_0_axi_intc/S_AXI/Reg] -force
