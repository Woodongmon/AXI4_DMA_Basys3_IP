...
################################################################
# This is a generated script based on design: soc_dma_test_v1
#
...
# source soc_dma_test_v1_script.tcl
...
set design_name soc_dma_test_v1
...
proc create_root_design { parentCell } {
  ...
  set Top_DMA_0 [ create_bd_cell -type ip -vlnv user.org:user:Top_DMA:1.3 Top_DMA_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M01_AXI] [get_bd_intf_pins Top_DMA_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net Top_DMA_0_m00_axi_error  [get_bd_pins Top_DMA_0/m00_axi_error] \
  [get_bd_pins microblaze_riscv_0_xlconcat/In2]
  connect_bd_net -net Top_DMA_0_m00_axi_txn_done  [get_bd_pins Top_DMA_0/m00_axi_txn_done] \
  [get_bd_pins microblaze_riscv_0_xlconcat/In1]
  connect_bd_net -net Top_DMA_0_m01_axi_error  [get_bd_pins Top_DMA_0/m01_axi_error] \
  [get_bd_pins microblaze_riscv_0_xlconcat/In4]
  connect_bd_net -net Top_DMA_0_m01_axi_txn_done  [get_bd_pins Top_DMA_0/m01_axi_txn_done] \
  ...
  [get_bd_pins Top_DMA_0/m00_axi_aclk] \
  [get_bd_pins Top_DMA_0/m01_axi_aclk] \
  [get_bd_pins Top_DMA_0/s00_axi_aclk]
  ...
  [get_bd_pins Top_DMA_0/m00_axi_aresetn] \
  [get_bd_pins Top_DMA_0/m01_axi_aresetn] \
  [get_bd_pins Top_DMA_0/s00_axi_aresetn]
  ...
  assign_bd_address -offset 0xC0000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC2000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  assign_bd_address -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M00_AXI] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M01_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC2000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M01_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  assign_bd_address -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces Top_DMA_0/M01_AXI] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] -force
